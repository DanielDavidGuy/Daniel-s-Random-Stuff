...
func init(modloader: Reference, params):
	...
	self.name = "Trash Can"
	self.description = "<color_E14A68>Destroys<end> adjacent symbols with a base value of <icon_coin><color_FBF236><value_2><end>. Gives <color_E14A68>1<icon_removal_token><end> for every <color_E14A68><value_1><end> symbols <color_E14A68>destroyed<end>."
