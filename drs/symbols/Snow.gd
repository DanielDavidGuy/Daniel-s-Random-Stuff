...
func init(modloader: Reference, params):
    ...
    self.name = "Snow"
    self.description = "<color_E14A68>Destroys<end> itself after <color_E14A68><value_1><end> spins. Gives <icon_coin><color_FBF236><value_2><end> more for <color_E14A68>each<end> other <icon_snow>."
