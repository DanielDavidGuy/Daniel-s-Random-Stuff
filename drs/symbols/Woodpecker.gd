...
func init(modloader: Reference, params):
    ...
    self.description = "<color_E14A68>Destroys<end> adjacent <all_and_woodlikes>. Gives <color_FBF236><icon_coin><value_1><end> for each <all_or_woodlikes> <color_E14A68>destroyed<end>."
